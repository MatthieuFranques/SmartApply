...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=coverage)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=bugs)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=MatthieuFranques_SmartApply&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=MatthieuFranques_SmartApply)
